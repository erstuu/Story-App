...
import com.erstuu.app.story.DataDummy
import com.erstuu.app.story.MainDispatcherRule
import com.erstuu.app.story.data.UserRepository
import com.erstuu.app.story.getOrAwaitValue
...
class MainViewModelTest {
    ...
    fun `when Get Quote Should Not Null and Return Data`() = runTest {
        ...
        val actualQuote: PagingData<Stories> = mainViewModel.getStories().getOrAwaitValue()
